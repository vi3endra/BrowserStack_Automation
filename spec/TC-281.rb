...
describe "Login Authentication - TC-281 " do

  it "Reject Login with Incorrect Username and Valid Password" do
    ...
    com_click $bstack_sign_in_password_dropdown_option.sub('?', "testingisfun99"), "1st Password"
