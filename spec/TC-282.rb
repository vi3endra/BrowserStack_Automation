...
describe "Login Authentication - TC-282" do
  
  it "Reject Login with Valid Username and Incorrect Password" do
    ...
    com_compare "Invalid Password", sign_in_error_text, "Sign In Error: "
  end
