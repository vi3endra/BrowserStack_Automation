...
describe "Locked Account - TC-286 " do

  it "Login Attempt Is Rejected with Appropriate Message" do
    ...
    com_click $bstack_sign_in_password_dropdown_option.sub('?', "locked_user"), "locked_user Username"
    ...
    com_compare "Your account has been locked.", sign_in_error_text, "Sign In Error: "
  end
